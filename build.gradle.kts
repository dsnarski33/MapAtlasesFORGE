...
plugins {
    ...
    //id("org.joml") version "1.10.5" // added for JOML
    //id("org.joml.joml") version "1.10.5" // added for JOML
...
val jomlVersion: String = "1.10.5" // added for JOML
...
val modId: String = "map_atlases" //System.getenv("VERSION") ?: "0.0.0-indev"
val modVersion: String = "0.9.2"
...
base {
    ...
    group = "com.llamastein.map_atlases"
    version = modVersion
}
...
repositories {
    mavenCentral()
    mavenLocal()
    maven(url = "https://oss.sonatype.org/content/repositories/snapshots/") // added for JOML
...
dependencies {
    ...
    implementation("org.joml:joml:${jomlVersion}") // added for JOML
...
//    }
    ...
    register("generateSources", Copy::class) {
        ...
        filesMatching("**/MapAtlasesMod.java") {
            expand(mapOf("version" to project.version))
        }
    }
